...
$s = mysqli_query($con, "SELECT * FROM invoices where user_id = '$user_id'  AND date ='$date'");
$num = mysqli_num_rows($s);
  if($num >= 1){
    $msg = "Record alraedy Exists!";
    echo "<script type='text/javascript'>alert('$msg');</script>";
    }else{
        $query = mysqli_query($con, "INSERT INTO invoices(user_id, date, totalamount, rent, water, electricity, internet, trash, balance) VALUE('$user_id', '$date', '$totalamount', '$rent', '$water', '$electricity', '$internet', '$trash', '$balance')");
  ...
  <?php require_once("header.php");?>
      ...
      <div class="left col col-md-6">
        ...
        <h2><span><span><b>2</b></span> Payments</h2>
          ...
          <div class="form-group">
            <label for="num">Rent:</label> <input class="form-control" id="rent" name="rent" type="number" value="6000" oninput="calc();">
          </div>
  
  
          <div class="form-group">
            <label for="usr">Water Bill:</label> <input class="form-control" name="water" id="water" type="text" value="500" oninput="calc();">
          </div>


          <div class="form-group">
            <label for="usr">Elecricity Bill:</label> <input class="form-control" id="electricity" name="electricity" type="text"  value="500" oninput="calc();">
          </div>


          <div class="form-group">
            <label for="usr">Internet Bill:</label> <input class="form-control" id="internet" name="internet" type="text" value="2500" oninput="calc();">
          </div>



          <div class="form-group">
            <label for="usr">Trash Bill:</label> <input class="form-control" id="trash" name="trash" type="text" value="200" oninput="calc();">
          </div>
