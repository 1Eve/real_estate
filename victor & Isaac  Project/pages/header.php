...
<body>
    ...
    <header>
		<div class="logo">ManHattan<span>Source Apartment</span></div>
	</header>
		...
		<div class="sidebar">
			<nav>
				...
				<?php if ($_SESSION['staff'] == 'landlord'){?>
					...
					<li><a href="updatepayments.php">Update Payments</a></li>
				...
				<?php }elseif($_SESSION['staff'] == 'tenant'){?>
					...
					<li><a href="add.php?q=	Contact">Contact Landlord</a></li>
					<li><a href="#"><?php echo $_SESSION['email']?></a></li>
					<li><a href="../includes/logout.php">LogOut</a></li>
